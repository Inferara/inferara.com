...
слой абстракции между исходным кодом и ассемблерным листингом, затрудняющий
прямое сопоставление. Таким образом, полная верификация рантайма Arbitrum издали
